...
export function BottomNav() {
  ...
  return (
    <div className="w-full backdrop-blur-lg bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 shadow-lg bottom-nav pb-safe pl-safe pr-safe z-50">
