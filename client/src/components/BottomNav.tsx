...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 w-full backdrop-blur-lg bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 shadow-lg bottom-nav pb-safe pl-safe pr-safe z-50">
      {/* iOS safe area padding bottom is handled with pb-safe class */}
      <div className="grid h-22 grid-cols-5 px-1 pt-2">
        {/* Left side items */}
